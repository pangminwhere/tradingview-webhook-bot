...
def execute_buy(symbol: str) -> dict:
    ...
    try:
        ...
        tp_price_1 = adjust_to_tick_size(entry_price * 1.005, tick_size)
    ...
    try:
        ...
        tp_price_2 = adjust_to_tick_size(entry_price * 1.011, tick_size)
    ...
    try:
        # SL: -0.5% ROI, 전체 물량
        sl_price = adjust_to_tick_size(entry_price * 0.995, tick_size)
        sl_qty = filled
