...
def execute_sell(symbol: str) -> dict:
    ...
    try:
        ...
        logger.info(f"SELL executed: {filled_qty} @ {entry_price}")
        ...
        return {"sell": {"filled": filled_qty, "entry": entry_price}}

    except BinanceAPIException as e:
        logger.exception(f"Binance API exception during SELL: {e}")
        return {"error": str(e)}
    except Exception as e:
        logger.exception(f"Exception during SELL: {e}")
        return {"error": str(e)}